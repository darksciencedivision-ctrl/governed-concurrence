...
Read the full position paper: [GOVERNED_CONCURRENCE_THESIS.md](GOVERNED_CONCURRENCE_THESIS.md)

Provenance (dated hash of the document): [PROVENANCE.md](PROVENANCE.md)
